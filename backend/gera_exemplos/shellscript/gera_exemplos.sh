...
if [[ $AMBIENTE =~ "desenvolvimento.attus" ]]; then
	SERVIDOR_PROCESSO='https://desenvolvimento.attus.ai/processo'
	SERVIDOR_UAA='https://desenvolvimento.attus.ai/uaa'
	SERVIDOR_DEMANDA='https://desenvolvimento.attus.ai/demanda'
	SERVIDOR_ADMIN='https://desenvolvimento.attus.ai/admin'
	SERVIDOR_PESSOA='https://desenvolvimento.attus.ai/pessoa'
	SERVIDOR_DIVIDA='https://desenvolvimento.attus.ai/divida'
	SERVIDOR_DOCUMENTO='https://desenvolvimento.attus.ai/documento'
	SERVIDOR_DISTRIBUICAO='https://desenvolvimento.attus.ai/distribuicao'
	SERVIDOR_INTEGRAJUD='https://desenvolvimento.attus.ai/integrajud'
...
if [[ $AMBIENTE =~ "treinamento.attus.ai" ]]; then
	SERVIDOR_PROCESSO='https://treinamento.attus.ai/processo'
	SERVIDOR_UAA='https://treinamento.attus.ai/uaa'
	SERVIDOR_DEMANDA='https://treinamento.attus.ai/demanda'
	SERVIDOR_ADMIN='https://treinamento.attus.ai/admin'
	SERVIDOR_PESSOA='https://treinamento.attus.ai/pessoa'
	SERVIDOR_DIVIDA='https://treinamento.attus.ai/divida'
	SERVIDOR_DOCUMENTO='https://treinamento.attus.ai/documento'
	SERVIDOR_DISTRIBUICAO='https://treinamento.attus.ai/distribuicao'
	SERVIDOR_INTEGRAJUD='https://treinamento.attus.ai/integrajud'
	AUTH_HEADER='Basic QVRUT1JOQVRVUzpjTVI7MzZuaEI5S3I8Rmtm'
fi
...
if [[ $? -eq 0 ]]; then
	...
	PROCESSO_NUMERO="1604999-25.2025.9.26.0053"
	...
	PROCESSO_NUMERO="1605001-42.2025.9.26.0053"

	PROCESSO_VALOR=78500

	PROCESSO_NOME_PARTE_CONTRARIA="Fernanda Oliveira Santos"

	PROCESSO_CPF_PARTE_CONTRARIA="487.652.310-55"
	...
	PROCESSO_NUMERO="1605002-88.2025.9.26.0053"

	PROCESSO_VALOR=92300

	PROCESSO_NOME_PARTE_CONTRARIA="Roberto Carlos Mendes"

	PROCESSO_CPF_PARTE_CONTRARIA="591.824.670-43"
	...
	PROCESSO_NUMERO="1605003-15.2025.9.26.0053"

	PROCESSO_VALOR=45200

	PROCESSO_NOME_PARTE_CONTRARIA="Juliana Pereira Costa"

	PROCESSO_CPF_PARTE_CONTRARIA="623.945.180-72"
	...
	PROCESSO_NUMERO="1605004-67.2025.9.26.0053"

	PROCESSO_VALOR=63800

	PROCESSO_NOME_PARTE_CONTRARIA="Anderson Silva Rodrigues"

	PROCESSO_CPF_PARTE_CONTRARIA="754.218.390-61"
	...
	PROCESSO_NUMERO="1605005-93.2025.9.26.0053"

	PROCESSO_VALOR=81700

	PROCESSO_NOME_PARTE_CONTRARIA="Patricia Almeida Ferreira"

	PROCESSO_CPF_PARTE_CONTRARIA="816.537.420-89"
	...
	PROCESSO_NUMERO="1705004-67.2025.9.26.0053"
	...
	PROCESSO_NUMERO="1705005-93.2025.9.26.0053"
